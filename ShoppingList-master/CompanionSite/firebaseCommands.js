...
document.getElementById("addProduct").addEventListener("click", function(){
  ...
  //unit should still have a value, otherwise 0 will be displayed to the user and that's not nice; so unit should have the same value as the quantity field 
  var unit = String(quantity);
